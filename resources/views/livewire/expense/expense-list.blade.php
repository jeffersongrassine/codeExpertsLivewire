<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <div class="w-full mx-auto text-right mt-5 mb-6">
    ...
    <table class="table-auto w-full mx-auto">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-4 py-2 border"><span class="{{$exp->type == 1 ? 'text-green-600' : 'text-red-600'}}">R$ {{number_format($exp->amount, 2, ',', '.')}}</span></td>
